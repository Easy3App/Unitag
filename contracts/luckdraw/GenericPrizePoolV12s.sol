...
contract GenericPrizePoolV12s is Multicall, TicketConsumer, SelfPermit {
    ...
    constructor(address weth9_, address signer_) TicketConsumer(signer_) {
        weth9 = IWETH9(weth9_);
    }
    ...
    function createPool(uint256 id) external {
        ...
        emit PoolCreated(id, 0, msg.sender);
    } 
